...
async def onHelp(user, interaction):
  ...
  await EmbedBuilder.EmbedWithAuthorBuilder(interaction, "Found the following arcade commands", f"Hi {user.display_name} i have found the following Arcade commands for you. If you have any suggestions please contact @Hatsune Elise#0071 \n\n **Arcade uttilty Commands** \n🎀 \Help --> Show this message\n **Elise Commands** \n🎀 \EGS --> Wanna know what the EGS series is? \n🎀 \Socials --> Il give you Elise her offical socials \n **Fun commands** \n*Coming soon* \n **Admin commands**\n *Coming soon*",     "https://cdn.discordapp.com/attachments/709057115159003156/1093643303519526952/2022_08_22_15_19_12.gif", 65463, "🎀 Miku stop hitting me :( 🎀", None, None, "Command List for the Arcade", "https://cdn.discordapp.com/attachments/491904770236481549/1093854438566924509/hatsune-miku-sleeping-sitting-twintails-wallpaper-preview.jpg")